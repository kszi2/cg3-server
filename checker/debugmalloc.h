...
static void *debugmalloc_realloc_full(void *oldmem, size_t newsize, char const *func, char const *expr, char const *file, unsigned line) {
    /* imitate standard realloc: equivalent to free if size is zero. */
    if (newsize == 0) {
...
static inline char * debugmalloc_strdup (const char *s, char const *func, char const *expr, char const *file, unsigned line)
{
  ...
  void *mem = debugmalloc_malloc_full (len, func, expr, file, line, 0);
...
static inline char * debugmalloc_strndup (const char *s, size_t n, char const *func, char const *expr, char const *file, unsigned line)
{
  ...
  void *mem = debugmalloc_malloc_full (len+1, func, expr, file, line, 0);
